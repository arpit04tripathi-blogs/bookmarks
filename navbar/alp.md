...
- FEB
  - Book : System Design Vol 1
  - Book : System Design Vol 2
- MAR
...
- JUNE
  ...
  - Udemy AWS Associcate

### Q3 2026
- JUL
  - Book : Spring Microservices in Action
  - Book : Spring Security in Action
    - [Youtube](https://www.youtube.com/watch?v=Of4HFbsPKqk&list=PLEocw3gLFc8XRaRBZkhBEZ_R3tmvfkWZz){:target="\_blank"} - 34 Hours
- AUG
  - [Docker](https://www.youtube.com/watch?v=3c-iBn73dDE){:target="\_blank"}
  - [Docker Mastery: with Kubernetes +Swarm from a Docker Captain](https://www.udemy.com/course/docker-mastery/learn/lecture/32367182?start=0#overview){:target="\_blank"}
